			...
			<div className='w-full px-[5vw] center'>
				<m.footer
					...
					<div className='absolute z-1 size-full rounded-3xl overflow-hidden'>
						{prefersMotion ? (
							<div className='size-full opacity-75'>
					...
					<div className='sm:shadow-2xl self-center z-10 sm:bg-light-500/50 text-black p-10 sm:backdrop-blur-xl rounded-3xl flex flex-col gap-3 items-start'>
						...
						<Link
							...
							<p className='text-2xl sm:text-4xl font-bold'>contact@thetimblank.com</p>
						</Link>
						<Link
							...
							<p className='text-2xl sm:text-4xl font-bold'>Github</p>
						</Link>
					</div>
					<m.div
						initial={{
						...
						<p className='text-[12vw] font-thin font-accent text-black/80 uppercase leading-none!'>
							Thetimblank
						</p>
					</m.div>
				</m.footer>
