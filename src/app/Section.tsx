...
const Section: React.FC<P> = ({
    ...
    return (
        <section
            className='w-full my-[10vh] flex flex-col items-center'
            {...props}
        >
            <m.div
                initial={{
            ...
            >
                ...
                {subtitle && (
                    <p className='text-xl sm:text-2xl mb-10 sm:mb-20 text-center px-5'>
                        {subtitle}
                    </p>
                )}
            </m.div>
            <div
                className={clsx(
                    'flex w-full',
                    windowPane &&
                        'max-xl:flex-col max-sm:gap-1 max-xl:gap-[15vh]',
                ...
                <div
                    className={
                        windowPane
                            ...
                            : 'w-[95%] sm:w-3/4 xl:w-1/2 flex flex-col'
                    }
                >
