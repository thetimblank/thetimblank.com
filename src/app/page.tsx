...
const Page: React.FC = () => {
    ...
    return (
        <div className='w-[100vw] max-sm:overflow-hidden'>
            <Nav />
            <div className='min-h-[80vh] center flex-col space-x-4overflow-hidden'>
                ...
                >
                    <Carousel
                        height={400}
                        items={projects.map((slide) => ({
                            name: slide.name,
                            image: slide.image ?? '',
                            description: slide.roles?.join(', ') ?? '',
                            url: slide.link ?? slide.github ?? '/',
                        }))}
                    />
                </m.div>
            </div>
            <div className='w-full my-20 leading-tight text-xl sm:text-4xl'>
                ...
                >
                    I&apos;d love to expand my experience to much larger, more
                    complex projects.
                </m.div>
                <m.div
                    className='px-[10%]'
                ...
                <Section
                    ...
                    className='mt-[10vh] pt-[10vh] bg-gradient-to-b from-light-800 dark:from-dark-600'
                    data={projects}
                    windowPane
                    highlightItems
                />
                ...
                />
                <Section
                    className='mt-[10vh] pt-[10vh] bg-gradient-to-b from-light-800 dark:from-dark-400'
